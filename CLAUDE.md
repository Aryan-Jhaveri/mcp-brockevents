Using the project knowledge, Lets create an MCP server that uses the rss feed of my university, to create an helpful events assistant ai

heres the link. https://experiencebu.brocku.ca/events.rss

I have also attached the format of rss feed to this chat
